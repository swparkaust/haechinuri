function getNestedValue(obj, key, defaultValue) {
  if (!obj || !key) return defaultValue !== undefined ? defaultValue : undefined;
  return key.split('.').reduce((o, k) => {
    if (o && typeof o === 'object' && k in o) return o[k];
    return undefined;
  }, obj) ?? (defaultValue !== undefined ? defaultValue : undefined);
}
...
module.exports = { getNestedValue, escapeHtml, getIcon };
